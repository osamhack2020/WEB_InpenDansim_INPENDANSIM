...
(function(root){
    ...
    sudoku.return_board = function(board){
        /* Print a sudoku `board` to the console.
        */
        ...
        var V_PADDING = "&nbsp";  // Insert after each square
        var H_PADDING = '<br>'; // Insert after each row
        
        var V_BOX_PADDING = "&nbsp&nbsp"; // Box vertical padding
        var H_BOX_PADDING = '<br>'; // Box horizontal padding
