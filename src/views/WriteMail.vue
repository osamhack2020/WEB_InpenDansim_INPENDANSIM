      ...
      <div class="utility-bar__content">
        <div v-if="utilityContentName == 'news'">
          ...
          <div class="navigation">
            <div
              ...
              :class="['navigation__button', {'focus': newsCategoryNum == index}]"
              :key="index"
            >
              {{ categoryName }}
            </div>
        ...
        <div v-if="utilityContentName == 'music'">
          ...
          <div class="playlists_container">
            <div v-for="(playlist, index) in musicPlaylists" class="playlist" :key="index">
              <div class="playlist__title">{{ playlist.title }}</div>
              <div class="playlist__song" v-for="(song, index) in playlist.songs" :key="index">
    ...
    return {
      ...
      newsHeadlines: [
        [
          ...
          {
            title:
              "“재산세 완화 추진…종부세는 유지” ‘부동산 늪’에 빠진 민주당",
            content:
